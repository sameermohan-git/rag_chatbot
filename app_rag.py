...
def cs_sidebar():
    ...
    st.sidebar.markdown('''[<img src='data:image/svg;base64,{}' class='img-fluid' width=32 height=32>](https://level5strategy.com/)'''.format(img_to_bytes("L5Logo.svg")), unsafe_allow_html=True)
