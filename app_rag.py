...
def cs_body():
    ...
    if st.session_state.pdf_processed:
        ...
        st.text_input("How can I help you?", key="user_input1", on_change=handle_enter, placeholder="Your AI assistant here! Ask me anything")

        st.chat_input(key="user_input", on_submit=handle_enter, placeholder="Your AI assistant here! Ask me anything")
